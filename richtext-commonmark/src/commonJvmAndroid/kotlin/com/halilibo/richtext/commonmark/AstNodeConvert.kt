...
@Composable
public actual fun parsedMarkdown(text: String, options: CommonMarkdownParseOptions): AstNode? {
  val parser = remember(options) {
    CommonmarkAstNodeParser(options)
  }

  val rootNode by produceState<AstNode?>(null, text, parser) {
